  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-display text-2xl">Service <span className="italic">Management</span></h1>
        <Button variant="hero" size="sm" onClick={openCreate}><Plus size={16} className="mr-1" /> Add Service</Button>
      </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/30">
                  {["Image", "Name", "Duration", "Price", "Status", "Actions"].map((h) => (
              ...
              <tbody>
                {filtered.filter((s) => s.category === cat).map((s) => (
                  <tr key={s.id} className="border-b border-border/50 hover:bg-muted/20">
                    ...
                    <td className="py-3 px-3 font-body text-sm">€{s.price}</td>
                    <td className="py-3 px-3">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground mb-1 block">Service Image URL</label>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                <label className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground mb-1 block">Duration (min)</label>
              ...
              <div>
                <label className="font-body text-xs uppercase tracking-[0.15em] text-muted-foreground mb-1 block">Price (€)</label>
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="active" className="font-body text-sm">Active</label>
            </div>
          </div>
          <DialogFooter>
