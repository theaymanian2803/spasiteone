        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            <div className="absolute top-8 left-8 bg-primary text-white rounded-2xl p-4 shadow-xl">
              <p className="font-body text-xs uppercase tracking-wider opacity-80">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: '-80px' }}
            transition={{ duration: 0.8 }}>
            <p className="font-body uppercase tracking-[0.3em] text-sm text-primary mb-4">
              {content.subtitle}
            </p>
              ...
              <motion.div
                ...
                <div>
                  <h4 className="font-display text-lg mb-1">
                    {content.experience_years} Années d'Expérience
                  </h4>
